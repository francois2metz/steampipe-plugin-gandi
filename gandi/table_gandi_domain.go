...
func tableGandiDomain() *plugin.Table {
	return &plugin.Table{
		...
		Columns: []*plugin.Column{
			...
			{Name: "dates_created_at", Type: proto.ColumnType_DATETIME, Transform: transform.FromField("Dates.CreatedAt"), Description: "The date the domain started to be handled by Gandi."},
			{Name: "dates_updated_at", Type: proto.ColumnType_DATETIME, Transform: transform.FromField("Dates.UpdatedAt"), Description: "The last update date."},
			{Name: "dates_deletes_at", Type: proto.ColumnType_DATETIME, Transform: transform.FromField("Dates.DeletesAt"), Description: "The date on which the domain will be deleted at the registry."},
			...
			{Name: "dates_hold_begins_at", Type: proto.ColumnType_DATETIME, Transform: transform.FromField("Dates.HoldBeginsAt"), Description: "The date from which the domain is held."},
			{Name: "dates_hold_ends_at", Type: proto.ColumnType_DATETIME, Transform: transform.FromField("Dates.HoldEndsAt"), Description: "The date from which the domain can’t be renewed anymore (the domain can be restored if the registry supports redemption period otherwise the domain might be destroyed at Gandi at that date)."},
			{Name: "dates_pending_delete_ends_at", Type: proto.ColumnType_DATETIME, Transform: transform.FromField("Dates.PendingDeleteEndsAt"), Description: "The date from which the domain will be available after a deletion."},
			...
			{Name: "dates_renew_begins_at", Type: proto.ColumnType_DATETIME, Transform: transform.FromField("Dates.RenewBeginsAt"), Description: "The date from which the domain can be renewed."},
